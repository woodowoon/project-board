...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "dowoonTest",  setupBefore = TestExecutionEvent.TEST_EXECUTION) // 실제 유저 정보를 가져온다. 실제 데이터에 있는 유저 정보
    // WithUserDetails 에서 userDetailsServiceBeanName = "userDetailsService" 옵션이 하나 더 있는데, Bean이 저게 유일해서 선언해주지 않아도 괜찮다.
    ...
    @WithUserDetails(value = "dowoonTest",  setupBefore = TestExecutionEvent.TEST_EXECUTION)
